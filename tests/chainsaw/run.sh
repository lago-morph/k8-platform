...
# Every chainsaw scenario here is kind-runnable and GATES on every push (no
# "nightly" / "non-gating" lane — AGENTS §6.36). Real-RDS behavioral coverage
# belongs in the gating live suite (tests/live/, fail-closed), NOT a schedule;
# see OI-2026-06-06-4 and docs/testing-debt-burndown.md item 2.
