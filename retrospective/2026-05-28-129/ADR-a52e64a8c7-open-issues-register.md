# ADR: docs/open-issues.md is the durable register of undiagnosed problems
...
- [`../../docs/open-issues.md`](../../docs/open-issues.md) — the canonical file.
